...
private void _displayImgInFrame() {
  ...
  JButton but1 = new JButton("Go To School");
...
private void initComponents() {
  ...
  //btnLatInc = new JButton("Increase");
  //btnLatDec = new JButton("Decrease");
  //======== this ========
  ...
  //======== dialogPane ========
  {
  	...
  	//======== contentPanel ========
  	{
  		...
  		((TableLayout)contentPanel.getLayout()).setHGap(10);
  		((TableLayout)contentPanel.getLayout()).setVGap(10);
